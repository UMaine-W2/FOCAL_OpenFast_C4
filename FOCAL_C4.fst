------- OpenFAST INPUT FILE ------------------------------------------- 
CCT-9 Campign 4 model. Input files to be run with OpenFAST 4.0.0. GitHub branch from Lu Wang (https://github.com/luwang00/openfast/tree/dev) compiled on March 7, 2023. 
---------------------- SIMULATION CONTROL -------------------------------------- 
...
"SeaState_DLC_1p6.dat"                			SeaStateFile    - Name of file containing sea state input parameters (quoted string)
"FOCAL_C4_HydroDyn.dat"  						HydroFile    - Name of file containing hydrodynamic input parameters (quoted string) 
"unused"      				                    SubFile      - Name of file containing sub-structural input parameters (quoted string) 
"FOCAL_C4_MoorDyn.dat"                  		MooringFile  - Name of file containing mooring system input parameters (quoted string) 
